...
INSERT INTO games (
    ...
    ('爆爆王', '競技遊戲', '《爆爆王》是競技類型的線上遊戲，玩家透過水球炸彈來擊敗對手。遊戲中有豐富的關卡和道具，玩家可以使用不同的策略來取得勝利。此外有社交功能可以其他玩家組隊、對戰和交流，增加了遊戲的樂趣和互動性。', 'MapleStory/cover.jpg', '["CrazyArcade/cover.jpg", "CrazyArcade/1.jpg", "CrazyArcade/2.jfif", "CrazyArcade/3.jpg", "CrazyArcade/4.jfif"]', '12', 'Nexon', 'Nexon', 18000),
